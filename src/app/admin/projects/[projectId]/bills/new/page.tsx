...
import { billStatusOptions } from "@/lib/admin/purchasing";
...
export default async function NewBillPage({
  ...
  const action = createBillAction.bind(null, project.id);

  return (
    <AdminShell title={`Bill for ${project.name}`} eyebrow="Financial">
      <div className="mb-6">
        <Link
      ...
      <form action={action} className="space-y-6">
        <section className="rounded-lg border border-black/10 bg-white p-5 shadow-sm">
          ...
          <div className="grid gap-4 md:grid-cols-[0.7fr_0.9fr_0.45fr_0.45fr_0.45fr]">
