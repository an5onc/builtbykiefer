              ...
              {processSteps.map((step, index) => (
                <div key={index} className="flex gap-8 group">
                  ...
                  <div className="flex-shrink-0 w-20">
                    <div className="w-20 h-20 bg-[#b92516] text-white rounded-full flex items-center justify-center text-2xl font-bold shadow-lg group-hover:scale-110 transition-transform">
                      {step.number}
                    </div>
                  </div>
                  ...
                  <div className="flex-grow pb-12 border-l-2 border-gray-200 pl-8 relative">
                    <div className="absolute w-4 h-4 bg-[#b92516] rounded-full -left-[9px] top-8"></div>

                    <div className="bg-gray-50 rounded-lg p-6 group-hover:shadow-lg transition-shadow">
                      <div className="flex items-start justify-between mb-4">
                        <h3 className="text-2xl font-bold text-gray-900">{step.title}</h3>
                        <span className="px-3 py-1 bg-[#b92516]/10 text-[#b92516] rounded-full text-sm font-medium">
                          {step.duration}
                        </span>
                      </div>
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-2">
                        {step.tasks.map((task, taskIndex) => (
                          <div key={taskIndex} className="flex items-center gap-2">
                            <svg className="w-5 h-5 text-[#b92516] flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="bg-white rounded-lg p-6 shadow-lg">
                <div className="w-16 h-16 bg-[#b92516]/10 rounded-full flex items-center justify-center mx-auto mb-4">
                  <svg className="w-8 h-8 text-[#b92516]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              {faqs.map((faq, index) => (
                <div key={index} className="bg-white border border-gray-200 rounded-lg p-6 hover:shadow-lg transition-shadow">
                  <h3 className="text-lg font-bold mb-2 flex items-start gap-2">
                    <span className="text-[#b92516] mt-1">Q:</span>
      ...
      <section className="py-20 bg-[#151515] text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link
              href="/contact"
              className="inline-block px-8 py-4 bg-[#b92516] text-white font-bold rounded-lg hover:bg-[#951e13] transition-colors"
            >
              Get Free Consultation
            </Link>
            <a
              href="tel:9705155059"
              className="inline-block px-8 py-4 bg-transparent border-2 border-white text-white font-bold rounded-lg hover:bg-white hover:text-[#151515] transition-colors"
            >
              Call (970) 515-5059
            </a>
          </div>
