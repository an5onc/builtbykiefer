...
import type { ChangeOrder, Client, Project } from "./types";
...
export function ChangeOrderPdf({
  ...
  return (
    <Document title={`${changeOrder.changeOrderNumber} - Kiefer Built Contracting`}>
      <Page size="LETTER" style={styles.page}>
        <View style={styles.header}>
          ...
          <View>
            ...
            <Text style={styles.muted}>{changeOrder.changeOrderNumber}</Text>
            <Text style={styles.muted}>Status {changeOrder.status}</Text>
            <Text style={styles.muted}>Schedule impact {changeOrder.scheduleImpactDays} days</Text>
          </View>
        </View>
        ...
        <View style={styles.section}>
          <Text style={styles.h2}>{changeOrder.title}</Text>
          <Text style={styles.callout}>{changeOrder.clientMessage}</Text>
        </View>

        <View style={styles.section}>
          <Text style={styles.h2}>Reason</Text>
          <Text>{changeOrder.reason}</Text>
        </View>
