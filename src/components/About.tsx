...
export default function About() {
  ...
  return (
    <section id="about" className="py-24 md:py-32 bg-sand-50" ref={ref}>
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid md:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            {/* Accent element */}
            <div className="absolute -bottom-4 -right-4 w-32 h-32 border-2 border-walnut-400 rounded-sm -z-10" />
          </motion.div>
          ...
          >
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-charcoal-800 mb-6 leading-tight">
              Building Dreams,
              <br />
              Shaping Futures
            </h2>
            <p className="text-charcoal-400 leading-relaxed mb-4">
              ...
              building exceptional homes in Northern Colorado. We create
              sanctuaries -- spaces that reflect who you are and how you live.
            </p>
            <p className="text-charcoal-400 leading-relaxed mb-8">
              ...
              commercial projects, we bring your vision to life with precision
              and care.
            </p>
